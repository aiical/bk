    ...
    var navs = [
        {
            ...
            "children": [{
                "title": "国家数据",
                "icon": "&#xe63c;",
                "href": "/Bg/Manage/Country"
            }, {
                "title": "层级数据",
                "icon": "&#xe63c;",
                "href": "/Bg/Manage/Degree"
            }, {
                "title": "教师数据",
                "icon": "&#xe609;",
                "href": "/Bg/TeacherTeam/Index"
            },
            {
                "title": "成功案例",
                "icon": "&#xe609;",
                "href": "/Bg/SuccessCase/Index"
            },
            {
                "title": "Banner管理",
                "icon": "&#xe609;",
                "href": "/Bg/Manage/BannerList"
            },
            {
                "title": "留学方案申请记录",
                "icon": "&#xe609;",
                "href": "/Bg/Manage/ConsultStatistics"
            }
            ]
        },
        {
            ...
            "icon": "fa-cogs",
            "spread": false,
            "href": "/Bg/Manage/About"
        }
    ];
    //todo:navs 后期菜单多 且需要权限控制（简单的企业站没必要）的话 再去根据权限获取菜单
    //设置navbar
    navbar.set({
        spreadOne: true,
